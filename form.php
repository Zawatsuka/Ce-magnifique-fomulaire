  ...
  <div class="container">
    ...
    <form method="POST">
      ...
      <span class="input-group-text border-0 bg-dark text-light" id="basic-addon1">Nom</span>
        <input type="text" class="form-control bg-secondary text-light p-3" pattern="[a-zA-Z -\D]+" name="name" aria-label="Name"
          aria-describedby="basic-addon1" title="Vous avez des chiffres dans votre nom vous ?" required>
        <?= $error['name'] ?? ''?>
        
        <span class="input-group-text border-0 bg-dark text-light" id="basic-addon1">Prenom</span>
        <input type="text" class="form-control bg-secondary text-light p-3" pattern="[a-zA-Z -\D]+" name="firstname" aria-label="firstname"
          aria-describedby="basic-addon1" title="Vous avez des chiffres dans votre prenom vous ?" required>
        <?= $error['firstname'] ?? ''?>
      </div>

      <!-- anniversaire + pays -->
      <div class="input-group mb-3">
        <span class="input-group-text  border-0 bg-dark text-light" id="basic-addon1">Date de naissance</span>
      ...
      <!-- nation + mail -->
      <div class="input-group mb-3">
        <span class="input-group-text border-0 bg-dark text-light" id="basic-addon1">Nationalité</span>
      ...
      <!-- telephone + diplome-->
      <div class="input-group mb-3">
        <span class="input-group-text border-0 bg-dark text-light" id="basic-addon1">Telephone</span>
        <input type="text" class="form-control bg-secondary text-light" pattern="((\+)33|0)[1-9](\d{2}){4}" name="phone" aria-label="phone"
          aria-describedby="basic-addon1" title="pas de lettre dans votre numero de tel !" required>
        <?= $error['phone'] ?? ''?>
      ...
      <!-- numero pole emploi + nombre de badge  -->
      <div class="input-group mb-3">
        <span class="input-group-text border-0 bg-dark text-light" id="basic-addon1">Numéro Pole Emploi</span>
      ...
      <!-- lien code Academy -->
      <div class="input-group mb-3">
        <span class="input-group-text border-0 bg-dark text-light" id="basic-addon1">Lien Code Academy</span>
        <input type="text" class="form-control bg-secondary text-light"
          pattern="(?:http(s)?:\/\/)?[\w.-]+(?:\.[\w\.-]+)+[\w\-\._~:/?#[\]@!\$&'\(\)\*\+,;=.]+" name="linkPass"
          aria-label="linkPass" aria-describedby="basic-addon1" required>
      </div>
    ...
    <img src="assets\img\tumblr_6d0827a9c35bfb290854e01298b812d6_2e4fb5c9_2048.gif" alt="femme neon" class="img-fluid ml-5">
  </div>